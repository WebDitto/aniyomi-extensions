...
object AnimesOtakuFilters {
    ...
    class GenresFilter : CheckBoxFilterList("Genres", AnimesOtakuFiltersData.GENRES)
    class StatusFilter : CheckBoxFilterList("Durumu", AnimesOtakuFiltersData.STATUS)
    class ProducersFilter : CheckBoxFilterList("Yapımcı", AnimesOtakuFiltersData.PRODUCERS)
    class StudiosFilter : CheckBoxFilterList("Stüdyo", AnimesOtakuFiltersData.GENRES)
    class TypesFilter : CheckBoxFilterList("Tür", AnimesOtakuFiltersData.TYPES)
    ...
    class YearFilter : QueryPartFilter("Yil", AnimesOtakuFiltersData.YEARS)
    class SeasonFilter : QueryPartFilter("Sezon", AnimesOtakuFiltersData.SEASONS)
